...
import { addAddress, deleteAddress, getAddress, login, updateAddress } from '../controller/user.controller.js'
...
userRouter.delete('/:userId/addresses/:addressId',isAuthenticated, deleteAddress);
